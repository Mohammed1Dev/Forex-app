...
//  }, [])
 ...
 return (
       <ScrollView>
   {/* Header  */}
   <ImageBackground source={require('../asset/forex.jpg')} style={styles.imgBack}>
     
   </ImageBackground>

        <ImageBackground source={require('../asset/bgScreen.png')} style={styles.infoRest}>
              <Text style={styles.nameRest}>Devises<Image source={require('../asset/shop.png')}/> </Text>
        </ImageBackground>
